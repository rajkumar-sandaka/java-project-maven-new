    ...
    <div class="movies-list">
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Avenger Endgame</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Fords v Ferrari</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Raj Ragnarokos</h2>
